...
<%-- 
    Document   : reporte
    Created on : 21/11/2019, 06:19:34 PM
    Author     : ARLEY
--%>
...
conexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/aventos","root",""); 
/*Establecemos la ruta del reporte*/ 
File reportFile = new File(application.getRealPath("reportes/reportes.jasper")); 
