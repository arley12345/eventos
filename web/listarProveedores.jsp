...
<html>
    ...
    <body>
       ...
       select * from proveedores
            ...
            <tr>        
                ...
                <td class="text-center"><c:out value="${fila.direccion}" /></td>     
        
               
                <td><a href="eliminarProveedor.jsp?id=${fila.id}">
                        <input type="submit" value="eliminar" class="btn btn-danger"/></a></td>
                <td><a href="actualizarProveedor.jsp?id=${fila.id}">
    ...
    <br>
            <a href="agregarProveedor.jsp?id=${fila.id}"><center>
                    <input type="submit" value="Agregar Proveedor" class="btn btn-warning"/></center></a>
