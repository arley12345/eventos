<%-- 
    ...
    Created on : 22/11/2019, 11:45:21 PM
    Author     : agend
--%>
...
<html>
    ...
    <center><body >
            ...
            <c:if test="${param.modifica == null}">
                <sql:query var="estado" dataSource="${universidad}">
                ...
                <form method="post" >
                    ...
                    <table>
                        <c:forEach  var="itema" items="${estado.rows}">
                            <tr><td></td>
                    ...
                    <a href="listaEstado.jsp">Regresar</a>
                    <tr>
            ...
            <c:if test="${param.modifica != null}">
                <sql:update var="result" dataSource="${universidad}">
                    update estado
                    set est_nombre='${param.est_nombre}'
                    where id = ${param.id}
                </sql:update>
                <c:if test="${result == 1}">
                <center><p>Registro Actualizado Satisfactoriamente!</p><br>
                    <a href="listaEstado.jsp">Regresar</a></center>
                </c:if>
            </c:if>
